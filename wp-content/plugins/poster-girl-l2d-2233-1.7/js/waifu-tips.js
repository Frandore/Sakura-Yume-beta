...
$('.waifu-tool .fa-drivers-license-o').click(function(){
        ...
        // $.post("https://m7.music.126.net/20191024083315/d895b9124619924df26b7c594a594177/ymusic/510c/565c/065c/ffccf7efcea66e2d1b1e160f633d584b.mp3",function(mp31){
        //     //showMessage(result);
        //     var mp3 = new Audio(mp31);
        //     mp3.play();
        // });
    ...
    if(model_p===22){
        ...
        model_p = 4;
        loadlive2d('live2d',l2d.xb+'/model/api.php?p='+model_p);
        showMessage('22援交有点累了，现在该我上场了',4000);
    }else if(model_p===4){

        model_p = 5;
        loadlive2d('live2d',l2d.xb+'/model/api.php?p='+model_p);
        showMessage('麻酱援交有点累了，现在该我上场了',4000);
    }else if(model_p===5){
        model_p = 22;
        loadlive2d('live2d',l2d.xb+'/model/api.php?p='+model_p+'&model=rand&r18='+l2d.r18);
        showMessage('Rinco援交有点累了，现在该我上场了',4000);
    }
...
$('.waifu-tool .fa-street-view').click(function (){
    ...
    var mp3 = new Audio(l2d.xb+'/model/ai.mp3');
    console.log('11')
    mp3.play(); //播放 mp3这个音频对象
    if(model_p===22) loadlive2d('live2d',l2d.xb+'/model/api.php?p=33&model=rand&r18='+l2d.r18); 
    else if(model_p===33)loadlive2d('live2d',l2d.xb+'/model/api.php?p=22&model=rand&r18='+l2d.r18);
    else if(model_p===4)loadlive2d('live2d',l2d.xb+'/model/api.php?p=4');
    else if(model_p===5)loadlive2d('live2d',l2d.xb+'/model/api.php?p=5');
...
loadlive2d('live2d',l2d.xb+'/model/api.php?p=4&model=default&r18='+l2d.r18);
