...
Description: 可以帮助你一键更换域名，用新链接替换旧的链接，单击“启用”，然后到<a href="tools.php?page=velvet-blues-update-urls.php">更新链接</a>页面替换链接。
Author: VelvetBlues.com | <a href="http://zmingcx.com/" target="_blank">基于官方3.2.7版，知更鸟汉化</a>
...
function VelvetBluesUU_add_management_page(){
	add_management_page("Velvet Blues Update URLs", "更新链接", "manage_options", basename(__FILE__), "VelvetBluesUU_management_page");
}
...
?>
		<div class="wrap">
		<h2><?php _e('Velvet Blues Update URLs','velvet-blues-update-urls'); ?></h2>
		<form method="post" action="tools.php?page=<?php echo basename(__FILE__); ?>">
			<?php wp_nonce_field('VBUU_submit','VBUU_nonce'); ?>
			<p><?php printf(__("After moving a website, lets you fix old URLs in content, excerpts, links, and custom fields.",'velvet-blues-update-urls'),'<strong>Update URLs</strong>'); ?></p>
			<p><strong>
			...
			<h3 style="margin-bottom:5px;">
				<?php _e('Step','velvet-blues-update-urls'); ?>
				1:
			...
			<table class="form-table">
				<tr>
					<td><p><?php _e('Select all','velvet-blues-update-urls'); ?></p>
